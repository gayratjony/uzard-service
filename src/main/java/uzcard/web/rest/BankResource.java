...
import uzcard.repository.BankRepository;
import uzcard.service.BankService;
...
public class BankResource {
    ...
    public ResponseEntity<BankDTO> createBank(@RequestBody BankDTO bankDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/banks/" + bankDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, bankDTO.getId().toString()))
            .body(bankDTO);
    }
     ...
     */
    @PutMapping("/{id}")
    public ResponseEntity<BankDTO> updateBank(@PathVariable(value = "id", required = false) final UUID id, @RequestBody BankDTO bankDTO)
    ...
    public ResponseEntity<BankDTO> partialUpdateBank(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, bankDTO.getId().toString())
        );
    }
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<BankDTO> getBank(@PathVariable("id") UUID id) {
